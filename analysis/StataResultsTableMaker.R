...
Temp <- c("KeeferOriginal", 'Honohan', "LVPre2001Keef", 'LVPre2001',
        'LVNoOnFull', "LVFull", 'KeeferLog', 'LVFullLogged')
...
Temp <- c("KeeferOriginal", 'Honohan', "LVPre2001Keef.x", "LVPre2001",
        "KeeferLog", "LVPre2001Keef.y")
Comb[, Temp][is.na(Comb[, Temp])] <- ""

names(Comb) <- c('', 'Keefer', 'HK', 'LV-Keefer', 'LV pre-2001', 'Keefer Log',
                'LV pre-2001 Log')

print(xtable(Comb, dcolumn = TRUE, booktabs = TRUE), size = 'scriptsize',
      include.rownames = FALSE, floating = FALSE,
      file = 'KeeferRepTable.tex')
